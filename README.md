...
```
cd existing_repo
git remote add origin https://para.cs.umd.edu/new_connections/new_connections.git
git branch -M main
...
- [ ] [Set up project integrations](https://para.cs.umd.edu/new_connections/new_connections/-/settings/integrations)
